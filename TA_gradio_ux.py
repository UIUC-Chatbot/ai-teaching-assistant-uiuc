...
class TA_Gradio():
  ...
  def question_answer(self, question: str, user_defined_context: str = '', use_gpt3: bool = False, image=None):
    ...
    if len(user_defined_context) == 0:
      ...
      generated_answers_list = self.ta.OPT_one_question_multiple_answers(USER_QUESTION,
    ...
    self.log_results_to_wandb(USER_QUESTION, generated_answers_list, final_scores, top_context_list, user_defined_context,
